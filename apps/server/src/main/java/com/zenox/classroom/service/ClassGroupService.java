...
public class ClassGroupService {
  ...
  public ClassRosterResponse roster(Long classGroupId) {
    ...
    ClassGroup classGroup = requireClassGroup(classGroupId, tenantId);
    return new ClassRosterResponse(
        ...
        classGroupMapper.listAvailableStudents(tenantId, classGroupId),
        classGroupMapper.listAvailableTeachers(tenantId, classGroupId)
    );
  }
